		...
		'dropdown' => [
			...
			'items' => [
				[
					...
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('publication', 'Hrzg Widget Template'),
				],
				[
					'url' => ['/publication/crud/hrzg-widget-template/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('publication', 'Hrzg Widget Template'),
				...
				[
					...
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('publication', 'Publication Category Translation'),
				],
				[
					'url' => ['/publication/crud/publication-item/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('publication', 'Publication Item'),
				],
