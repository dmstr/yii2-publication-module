		...
		'dropdown' => [
			...
			'items' => [
				...
				[
					...
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('publication', 'Publication Item Meta'),
				],
				[
					'url' => ['/publication/crud/publication-item-translation/index'],
					'label' => '<i class="glyphicon glyphicon-arrow-right"></i> ' . Yii::t('publication', 'Publication Item Translation'),
				],
