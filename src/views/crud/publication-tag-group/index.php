 ...
 * @var dmstr\modules\publication\models\crud\search\PublicationTagGroup $searchModel
 */

$this->title = Yii::t('publication', 'Publication Tag Groups');
...
<div class="giiant-crud publication-tag-index">
                    ...
                    'dropdown' => [
                        ...
                        'items' => [
                            [
                                ...
                                'label' => FA::icon(FA::_RANDOM) . ' ' . Yii::t('publication', 'Tags'),
                            ]
                        ]
                    ],
                    'options' => [
    ...
    <div class="table-responsive">
        <?php echo GridView::widget([
            ...
            'rowOptions' => function (PublicationTagGroup $model) {
            ...
            'columns' => [
                ...
                [
                    ...
                    'buttons' => [
                        ...
                        'update' => function ($url, PublicationTagGroup $model) {
                            $options = [
                        ...
                        'delete' => function ($url, PublicationTagGroup $model) {
                            $options = [
                    ...
                    'urlCreator' => function ($action, PublicationTagGroup $model, $key) {
