...
<div class="giiant-crud publication-item-meta-view">
    ...
    <?php $this->beginBlock('dmstr\modules\publication\models\crud\PublicationItemMeta'); ?>
		...
		'attributes' => [
			...
			[
				...
				'value' => ($model->item ?
					...
					Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'PublicationItemMeta'=>['item_id' => $model->item_id]])
					:
	...
	[
		...
		'items' => [
			[
				...
				'content' => $this->blocks['dmstr\modules\publication\models\crud\PublicationItemMeta'],
				'active'  => true,
			],
		]
	]
