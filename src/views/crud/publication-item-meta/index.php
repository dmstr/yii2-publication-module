 ...
 */
$this->title = Yii::t('publication', 'Publication Item Metas');
...
?>
<div class="giiant-crud publication-item-meta-index">
...
?>
    ...
    <h1>
        <?php echo Yii::t('publication', 'Publication Item Metas') ?>
        <small>
            List
        </small>
    </h1>
		...
		'dropdown' => [
			...
			'items' => [
				[
					...
					'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('publication', 'Publication Item'),
				],
