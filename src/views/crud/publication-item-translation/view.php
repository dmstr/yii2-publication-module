		...
		'attributes' => [
			...
			[
				...
				'value' => ($model->publicationCategory ?
					Html::a('<i class="glyphicon glyphicon-list"></i>', ['/publication/crud/publication-category-translation/index']).' '.
					Html::a('<i class="glyphicon glyphicon-circle-arrow-right"></i> '.$model->publicationCategory->title, ['/publication/crud/publication-category-translation/view', 'id' => $model->publicationCategory->id, ]).' '.
					Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'PublicationItemTranslation'=>['publication_category_id' => $model->publication_category_id]])
					:
					'<span class="label label-warning">?</span>'),
			],
			'language_code',
